...
/// </summary>
/// <remarks>All cancellation token parameters are optional.</remarks>
public interface IGraphService
{
    ...
    Task<List<User>> GetUsersAsync(int top = 100, int skip = 0, CancellationToken cancellationToken = default);
    ...
    Task<User> UpdateUserAsync(User user, string userId, CancellationToken cancellationToken = default);
    ...
    Task<List<string>> GetUserDirectGroupIdsAsync(string userId, CancellationToken cancellationToken = default);
    ...
    Task<List<string>> GetUserTransitiveGroupIdsAsync(string userId, CancellationToken cancellationToken = default);
    ...
    Task<List<Group>> QueryGroupsAsync(string? displayName = null, CancellationToken cancellationToken = default);
    ...
    Task<Group> CreateGroupAsync(string displayName, string mailNickname, CancellationToken cancellationToken = default);
    ...
    Task<Group> UpdateGroupAsync(string groupId, string displayName, string mailNickname, CancellationToken cancellationToken = default);
    ...
    Task AddUserToGroupsAsync(string userId, List<string> groupIds, CancellationToken cancellationToken = default);
    ...
    Task RemoveUserFromGroupsAsync(string userId, List<string> groupIds, CancellationToken cancellationToken = default);
